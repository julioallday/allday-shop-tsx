  ...
  return (
    <>
      <div className="md:flex min-h-screen relative">
        ...
        <div className="bg-azul-claro font-inter flex justify-center items-center w-screen h-screen">

          <main className="flex px-6 drop-shadow-2xl lg:w-3/4">
            <section className="bg-azul-escuro hidden max-h-2/3 lg:flex w-[42%] rounded-l-lg">
              <Image
                className="p-6 pt-4  m-auto"
                src={imagemMergulhador}
                alt="icone de mergulhador"
              />  
            </section>
            <section className="bg-white p-10 flex gap-6 flex-col rounded-lg lg:w-1/2 justify-center lg:rounded-l-none">
              <div className="self-center relative group">
                ...
                <svg
                  className="w-12 h-12 hover:animate-sino fill-azul-claro stroke-azul-escuro"
                  viewBox="0 0 24 24"
                  xmlns="http://www.w3.org/2000/svg"
                >
                  <path
              ...
              <div className="text-center">
                <h1 className="text-4xl mb-2">Assine nossa Newsletter</h1>
                <p className="text-xl text-gray-700 mb-2">
                  Receba atualizações sobre as notícias mais quentes da semana
                </p>
              </div>
              <form>
